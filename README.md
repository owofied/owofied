...
2. **[VigilantTF](https://github.com/VigilantTF)**: Third-party anticheat solution for Team Fortress 2
3. **[PurrPass](https://github.com/XiroXD/PurrPass)**: Password manager that reinvents the wheel...
4. **OwO Bot**: Discord selfbot written in Python that was intended to be public but ended up being private for obvious reasons...
